...
- 합성 데이터·전용 계정·격리된 테넌트를 사용한다
- 운영 데이터 복제와 비밀 커밋을 금지한다
- 고정 seed·시간과 명확한 정리 절차를 둔다

## 실행 절차

1. 정상·경계·악성 입력의 작은 fixture를 만든다
2. 데이터 수명·접근 권한·삭제 일정을 기록한다
...
지나치게 단순한 데이터는 실제 크기 문제를 숨긴다. 민감 원본 없이 규모와 분포를 모사한다.
