...
- 터치 영역·레이블·대비는 자동 검사한다
- 읽기 순서·포커스 복구·이해 가능성은 수동 확인한다
- WCAG 항목별 증거와 적용 불가 이유를 기록한다

## 실행 절차

1. 위젯 테스트에서 접근성 guideline을 실행한다
2. TalkBack·VoiceOver·키보드로 핵심 흐름을 수행한다
...
자동 통과는 인증이 아니다. 실제 사용자 흐름과 장애 유형별 수동 평가를 출시 증거로 남긴다.
