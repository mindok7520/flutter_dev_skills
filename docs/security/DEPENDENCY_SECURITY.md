...
직접·전이 패키지와 네이티브 구성 요소의 위험을 관리한다.
...
- pub outdated는 취약점 검사기가 아니다
- OSV·공식 보안 공지·공급자 릴리스 노트를 확인한다
- 유지보수 중단·불명확한 라이선스·과도한 권한도 평가한다

## 실행 절차

1. 잠금 파일과 플랫폼 잠금 파일에서 실제 버전을 확인한다
2. 영향 경로·수정 버전·완화·업그레이드 비용을 기록한다
...
최신 버전도 안전을 보증하지 않는다. 미수정 취약점은 노출 경로 차단과 제거 대안을 평가한다.
