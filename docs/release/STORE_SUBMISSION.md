...
- 설명·스크린샷·가격·연령 등급은 실제 기능을 반영한다
- 개인정보·데이터 안전 공개는 SDK 수집까지 포함한다
- 디지털/실물 상품과 국가별 결제 정책을 확인한다

## 실행 절차

1. 지원 URL·개인정보 URL·심사 계정·테스트 절차를 준비한다
2. 스토어별 최신 정책을 확인하고 승인된 산출물을 제출한다
3. 변경 이유, 영향 파일, 실행한 명령·환경·결과를 해당 이슈의 실행 계획에 기록한다. 적용하지 않은 항목은 이유와 후속 작업을 남긴다.

## 검증과 완료 증거

- [ ] 상품·복원·구독 관리·계정 삭제 흐름이 설명과 일치한다
- [ ] 출시되지 않은 기능을 가능하다고 홍보하지 않는다
