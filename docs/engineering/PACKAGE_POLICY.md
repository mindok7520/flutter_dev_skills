...
새 의존성의 유지보수·보안·플랫폼 비용을 사전에 평가한다.
...
- SDK 기능으로 해결 가능한지 먼저 확인한다
- 공식 출처·라이선스·활동·문제 대응·네이티브 의존성을 조사한다
- 앱 잠금 파일을 커밋하고 미고정 git 의존성을 거부한다

## 실행 절차

1. 현재·후보 버전과 지원 SDK를 비교한다
2. 최소 실험으로 플랫폼·웹/Wasm·크기·초기화 비용을 검증한다
