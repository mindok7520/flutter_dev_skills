---
name: privacy
description: "Flutter 저장소에서 개인정보 동의 작업을 수행한다. 사용자가 개인정보 동의을 요청하거나 관련 이슈의 조사·구현·검증이 필요할 때 사용한다. 다른 분야의 무관한 작업에는 자동 적용하지 않는다."
---
...
- [CONSENT_MANAGEMENT](../../../docs/privacy/CONSENT_MANAGEMENT.md)
- [DATA_INVENTORY](../../../docs/privacy/DATA_INVENTORY.md)
- [작업 프롬프트](../../../prompts/35-privacy-consent.md)
...
2. 필드·목적·공급자·국가·연령을 목록화한다
3. 필수 처리와 선택적 수집·동의·철회를 분리한다
4. 실제 전송과 저장이 선택에 맞게 멈추는지 확인한다
...
**데이터 목록·동의 상태 전이·삭제·증거**를 제공하라. 주요 판단은 사실·가정·권장으로 구분하고 코드 경로·명령·결과로 뒷받침하라. 추측성 지적이나 구현을 복제하는 테스트를 늘리지 마라. 코드·주석·식별자는 영어, 설명은 한국어로 작성하라.
