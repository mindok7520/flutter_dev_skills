---
name: responsive-ui
description: "Flutter 저장소에서 적응형 화면 검토 작업을 수행한다. 사용자가 적응형 화면 검토을 요청하거나 관련 이슈의 조사·구현·검증이 필요할 때 사용한다. 다른 분야의 무관한 작업에는 자동 적용하지 않는다."
---
...
- [작업 프롬프트](../../../prompts/19-responsive-review.md)
...
2. 좁은 폭·경계 폭·큰 창·회전·분할 화면을 확인한다
3. 글자 확대와 입력 방식 변화에서 구조를 검사한다
4. 기기 이름 대신 가용 공간과 작업 목적에 맞게 수정한다
...
**플랫폼/폭 표·오버플로·개선·증거**를 제공하라. 주요 판단은 사실·가정·권장으로 구분하고 코드 경로·명령·결과로 뒷받침하라. 추측성 지적이나 구현을 복제하는 테스트를 늘리지 마라. 코드·주석·식별자는 영어, 설명은 한국어로 작성하라.
